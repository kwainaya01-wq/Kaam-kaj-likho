...
window.downloadPDF = (workerId, workerName) => {
    try {
        // Yahan 'window.jspdf' se library pick kar rahe hain taaki ReferenceError na aaye
        ...
        // WebView/APK Fix: Using Data URL instead of .save()
        const pdfData = doc.output('datauristring');
        const link = document.createElement('a');
        link.href = pdfData;
        link.download = `${workerName}_Hisab.pdf`;
